    ...
    <div class="card">
        ...
        <form:form action="/register" method="post" modelAttribute="newUser">
            ...
            <form:select path="country">
                <form:option value="" label="-- Chose Your Country --"/>
            ...
            <div class="choice-group">
                <span class="choice-item">
                    ...
                    <label for="genderMale" style="margin:0;font-weight:500;">Male</label>
                </span>
                <span class="choice-item">
                    <form:radiobutton path="gender" value="Female" id="genderFemale" />
                    <label for="genderFemale" style="margin:0;font-weight:500;">Female</label>
                </span>
            </div>
            ...
            <form:label path="languages">Programming Language</form:label>
            <div class="choice-group checkboxes">
                <form:checkboxes path="languages" items="${languageOptions}"
                                 element="span class='choice-item'" />
            </div>
